...
//* we have created the funciton now we have to export it so that it will become usefull in the app.js

module.exports = userRequestHandler;
//* if we want to export multiple funciton then have to export like object
